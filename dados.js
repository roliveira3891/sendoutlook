...
module.exports = {
    async datatable(tecnologia) { 
        ...
        const ttable = `<tr><td width=50 nowrap colspan=12 style='width:37.5pt;border:solid #D9D9D9 1.0pt;background:#248CC1;padding:3.0pt 3.0pt 3.0pt 3.0pt'><p class=MsoNormal align=center style='text-align:center'><b><span style='font-family:"Candara",sans-serif;color:#F4F6F7'>ANALITICO ${tecnologia} "S 6" (Platinum)</span></b><o:p></o:p></p></td></tr>
        <tr>
        ...
        <td width=50 nowrap style='width:37.5pt;border:solid #D9D9D9 1.0pt;border-top:none;background:#EBEBEB;padding:2.25pt 5.25pt 2.25pt 5.25pt'><p class=MsoNormal align=center style='text-align:center'><b><span style='font-size:9.0pt;font-family:"Candara",sans-serif;color:black'>DATA_AGENDAMENTO</span></b><o:p></o:p></p></td>
        <td width=50 nowrap style='width:37.5pt;border:solid #D9D9D9 1.0pt;border-top:none;background:#EBEBEB;padding:2.25pt 5.25pt 2.25pt 5.25pt'><p class=MsoNormal align=center style='text-align:center'><b><span style='font-size:9.0pt;font-family:"Candara",sans-serif;color:black'>TIME_SLOT</span></b><o:p></o:p></p></td>
        ...
        for(item of results){
            ...
            dtable += `<td nowrap style='border:solid #DDDDDD 1.0pt;border-top:none;padding:2.25pt 5.25pt 2.25pt 5.25pt'><p class=MsoNormal align=center style='text-align:center'><span style='font-size:9.0pt;font-family:"Calibri",sans-serif;color:#7B7B7B'>${item[13]}</span><o:p></o:p></p></td>`
